...
$sql_query = "insert into adherent set nomAdherent=:nomAdherent, prenomAdherent=:prenomAdherent, photo_idPhoto=(select idPhoto from photo where entreprise_idEntreprise=:idEntreprise), adherent_idEntreprise=:idEntreprise";
