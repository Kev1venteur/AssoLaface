...
-- Généré le :  Sam 15 Juin 2019 à 23:33
...
(3, 'sarl-boutemine-roger@orange.fr', '02 51 35 61 82', 'Place des Anciens Combattants, 85300 FROIDFOND', 'https://www.pagesjaunes.fr/pros/53484537', 3, NULL),
...
(35, 'cmobois85@gmail.com\r\n', '06 27 24 26 86', 'L\' Enchaizière, 85300 FROIDFOND', NULL, 11, NULL);
...
(1, 'site web fini', '2019-06-01', 'place du champ de foire froidfond pres mairies', 4545, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley oi'),
(7, 'ferfref', '2019-06-20', 'grgtr', 552, 'grtg'),
(8, 'erzegterg', '2019-06-18', 'gtrgter', 78, 'gergtr'),
(9, 'fezr', '2019-06-16', 'ecr', 58, 'cr');
...
--
ALTER TABLE `adherent`
  MODIFY `idAdherent` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT pour la table `coordonnees`
--
ALTER TABLE `coordonnees`
  MODIFY `idCoordonnees` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
-- AUTO_INCREMENT pour la table `entreprise`
--
ALTER TABLE `entreprise`
  MODIFY `idEntreprise` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
...
--
ALTER TABLE `evenement`
  MODIFY `idEvenement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
