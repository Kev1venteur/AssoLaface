    ...
    <div class="header">
      <nav>
        <div class="nav-wrapper blue lighten-2">
          <a href="/assolaface/index.php"><img class="brand-logo" src="/assolaface/pictures/head_only.png" alt="face-logo"></img></a>
          <a href="#" class="sidenav-trigger" data-target="mobile-links"><i class="material-icons">menu</i></a>
          <a href="/assolaface/index.php" class="brand-logo center hide-on-med-and-down">
            <img class="brand-name-image" src="/assolaface/pictures/text_only.png" alt="text-logo"></img>
          </a>
          <ul id="nav-mobile" class="right hide-on-med-and-down">
            <li><a href="/assolaface/user/page/members_view.php">Adhérents &nbsp;&nbsp;&nbsp;<span class="material-icons">people</span></a></li>
            <li><a href="/assolaface/user/page/events_view.php">Evénements à venir &nbsp;&nbsp;&nbsp;<span class="material-icons">date_range</span></a></li>
          </ul>
        </div>
      </nav>
